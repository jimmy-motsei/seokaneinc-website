...
export function SiteFooter() {
  return (
    <footer className="bg-white border-t border-[var(--color-surface-dark)]">
      <div className="container-site grid gap-10 py-14 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
        {/* Column 1: Brand */}
        ...
        <div>
          ...
          <ul role="list" className="space-y-3 text-sm text-[var(--color-ink-muted)]">
            ...
            <li className="flex items-center gap-2">
              ...
              <a href={`tel:${office.phone.replace(/\s+/g, "")}`} className="transition-colors hover:text-[var(--color-ink)]">
                {office.phone}
              </a>
            </li>
            <li className="flex items-center gap-2">
